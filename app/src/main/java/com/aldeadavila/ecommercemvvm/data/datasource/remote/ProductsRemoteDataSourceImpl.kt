...
class ProductsRemoteDataSourceImpl(private val productsService: ProductsService): ProductsRemoteDataSource {
    ...
    override suspend fun updateWithImage(id:String, product: Product, files: List<File>?): Response<Product> {
    ...
    override suspend fun detele(id: String): Response<Unit> = productsService.delete(id)
}