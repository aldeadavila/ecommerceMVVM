...
import com.aldeadavila.ecommercemvvm.ui.screens.client.category.list.ClientCategoryListViewModel
import com.aldeadavila.ecommercemvvm.ui.screens.profile.components.ClientCategoryListContent

@Composable
fun GetCategories(paddingValues: PaddingValues, navHostController: NavHostController, vm: ClientCategoryListViewModel = hiltViewModel()) {
    ...
    when(val response = vm.categoriesResponse) {
        ...
        is Resource.Succes -> {
           ...
           ClientCategoryListContent(paddingValues = paddingValues, navHostController, categories = response.data )
