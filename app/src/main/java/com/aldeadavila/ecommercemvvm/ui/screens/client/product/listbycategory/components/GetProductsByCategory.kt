...
@Composable
fun GetProductsByCategory(navHostController: NavHostController, paddingValues: PaddingValues, vm: ClientProductListByCategoryViewModel = hiltViewModel()) {
    ...
    when(val response = vm.productResponse) {
        ...
        is Resource.Succes -> {
           ...
           ClientProductListByCategoryContent(navHostController, paddingValues = paddingValues, products = response.data)
