...
@Composable
fun GetProducts(navHostController: NavHostController, paddingValues: PaddingValues, vm: ClientProductListViewModel = hiltViewModel()) {
    ...
    when(val response = vm.productsResponse) {
        ...
        is Resource.Succes -> {
           ...
           ClientProductListContent(navHostController, paddingValues = paddingValues, products = response.data)
